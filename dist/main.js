...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ./pics/trash.svg */ "./src/pics/trash.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ./pics/star.svg */ "./src/pics/star.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_2___ = new URL(/* asset import */ __webpack_require__(/*! ./pics/star-fill.svg */ "./src/pics/star-fill.svg"), __webpack_require__.b);
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "/* http://meyerweb.com/eric/tools/css/reset/ \n   v2.0 | 20110126\n   License: none (public domain)\n*/\nhtml, body, div, span, applet, object, iframe,\nh1, h2, h3, h4, h5, h6, p, blockquote, pre,\na, abbr, acronym, address, big, cite, code,\ndel, dfn, em, img, ins, kbd, q, s, samp,\nsmall, strike, strong, sub, sup, tt, var,\nb, u, i, center,\ndl, dt, dd, ol, ul, li,\nfieldset, form, label, legend,\ntable, caption, tbody, tfoot, thead, tr, th, td,\narticle, aside, canvas, details, embed, \nfigure, figcaption, footer, header, hgroup, \nmenu, nav, output, ruby, section, summary,\ntime, mark, audio, video {\n\tmargin: 0;\n\tpadding: 0;\n\tborder: 0;\n\tfont-size: 100%;\n\tfont: inherit;\n\tvertical-align: baseline;\n}\n/* HTML5 display-role reset for older browsers */\narticle, aside, details, figcaption, figure, \nfooter, header, hgroup, menu, nav, section {\n\tdisplay: block;\n}\nbody {\n\tline-height: 1;\n}\nol, ul {\n\tlist-style: none;\n}\nblockquote, q {\n\tquotes: none;\n}\nblockquote:before, blockquote:after,\nq:before, q:after {\n\tcontent: '';\n\tcontent: none;\n}\ntable {\n\tborder-collapse: collapse;\n\tborder-spacing: 0;\n}\n\n* {\n    box-sizing: border-box;\n    /*outline: 1px red dashed;*/\n    --main-bg-color: rgb(87, 111, 114);\n    --side-bg-color: rgb(125, 157, 156);\n    --content-bg-color: rgb(237, 231, 221);\n    --secondary-bg-color: rgb(247, 244, 239);\n    --project-bg-color: rgb(169, 200, 199);\n    --selected-bg-color: rgb(200, 239, 238);\n    --hover-bg-color: rgb(255, 253, 249);\n}\nbody {\n    display: flex;\n    flex-direction: column;\n\n    height: 100vh;\n}\nheader {\n    display: flex;\n    align-items: center;\n\n    height: 105px;\n    background-color: var(--main-bg-color);\n    color: var(--secondary-bg-color);\n    font-size: 55px;\n\n    #logo {\n        height: 88px;\n    }\n}\n\nmain {\n    flex: 1;\n    display: grid;\n    grid-template: 1fr / 250px 1fr;\n    .side-bar {\n        display: flex;\n        flex-direction: column;\n        background-color: var(--side-bg-color);\n        #nav-button {\n            appearance: none;\n            background-color: var(--project-bg-color);\n            border-width: 0;\n            box-sizing: border-box;\n            color: black;\n            cursor: pointer;\n            display: inline-block;\n            font-family: Clarkson,Helvetica,sans-serif;\n            font-size: 14px;\n            font-weight: 700;\n            letter-spacing: 0;\n            line-height: 1em;\n            margin: 0;\n            opacity: 1;\n            outline: 0;\n            padding: 1.5em 2.2em;\n            position: relative;\n            text-align: center;\n            text-decoration: none;\n            text-rendering: geometricprecision;\n            text-transform: uppercase;\n            transition: opacity 300ms cubic-bezier(.694, 0, 0.335, 1),background-color 100ms cubic-bezier(.694, 0, 0.335, 1),color 100ms cubic-bezier(.694, 0, 0.335, 1);\n            user-select: none;\n            -webkit-user-select: none;\n            touch-action: manipulation;\n            vertical-align: baseline;\n            white-space: nowrap;\n        }\n        #nav-button:before {\n            animation: opacityFallbackOut .5s step-end forwards;\n            backface-visibility: hidden;\n            background-color: var(--selected-bg-color);\n            clip-path: polygon(-1% 0, 0 0, -25% 100%, -1% 100%);\n            content: \"\";\n            height: 100%;\n            left: 0;\n            position: absolute;\n            top: 0;\n            transform: translateZ(0);\n            transition: clip-path .5s cubic-bezier(.165, 0.84, 0.44, 1), -webkit-clip-path .5s cubic-bezier(.165, 0.84, 0.44, 1);\n            width: 100%;\n        }\n\n        #nav-button:hover:before {\n            animation: opacityFallbackIn 0s step-start forwards;\n            clip-path: polygon(0 0, 101% 0, 101% 101%, 0 101%);\n        }\n\n        #nav-button.selected {\n            background-color: var(--selected-bg-color);\n        }\n\n        #nav-button span {\n            z-index: 1;\n            position: relative;\n        }\n        #project-title {\n            font-size: 35px;\n            padding: 10px;\n            color: var(--secondary-bg-color);\n        }\n        #projects {\n            display: flex;\n            flex-direction: column;\n        }\n        #add-project {\n            border: 0;\n            padding: 10px;\n            font-size: larger;\n            font-weight: 900;\n            background-color: var(--project-bg-color);\n        }\n        #add-project:hover {\n            background-color: var(--selected-bg-color);\n        }\n    }\n    .content {\n        background-color: var(--content-bg-color);\n        color: black;\n        #content-header {\n            font-size: 35px;\n            display: flex;\n            align-items: end;\n            padding: 5px;\n            gap: 15px;\n\n            #date-string {\n                font-size: 18px;\n            }\n        }\n        #task-container,\n        #inbox-container {\n            display: flex;\n            flex-direction: column;\n            .late {\n                color: rgb(255, 113, 113);\n            }\n            #tasks,\n            #inboxs {\n                .card:hover {\n                    background-color: var(--hover-bg-color);\n                }\n                .card {\n                    padding: 10px;\n                    display: grid;\n                    grid-template: 3fr 2fr / 50px 8fr 50px;\n                    background-color: var(--secondary-bg-color);\n                    \n                    .check{\n                        grid-row: 1 / span 2;\n                        grid-column: 1;\n                    }\n                    .title{\n                        grid-row: 1;\n                        grid-column: 2 / 3;\n                        font-size: 20px;\n                    }\n                    .info{\n                        grid-row: 2 / 3;\n                        grid-column: 2 / 3;\n                        display: flex;\n                        gap: 10px;\n                        .date {\n                            flex: 1;\n                        }\n                    }\n                    .star{\n                        grid-row: 1 / span 2;\n                        grid-column: 3;\n                    }\n                    .trash {\n                        grid-row: 1 / span 2;\n                        grid-column: 3;\n                        background: no-repeat center url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");\n                        background-size: 30px;\n                    }\n                }\n            }\n            #add-task {\n                border: 0;\n                padding: 5px;\n                font-size: large;\n                font-weight: 900;\n                background-color: var(--secondary-bg-color);\n            }\n            #add-task:hover {\n                background-color: var(--hover-bg-color);\n            }\n        }\n    }\n}\nfooter {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    gap: 15px;\n\n    height: 50px;\n    font-size: 18px;\n    background-color: var(--main-bg-color);\n    color: var(--secondary-bg-color);\n}\n\n.hidden {\n    display: none;\n}\n#project-form {\n    height: 230px;\n}\n#overlay {\n    position: fixed;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n    background-color: rgba(0, 0, 0, 0.5);\n    z-index: 1;\n}\nform {\n    height: 400px;\n    width: 500px;\n    position: absolute;\n    top: 50%;\n    left: 50%;\n    transform: translate(-50%, -50%);\n    padding: 20px;\n    background-color: #fff;\n    box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);\n    z-index: 2;\n    background-color: var(--content-bg-color);\n\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    justify-content: space-evenly;\n\n    #description,\n    #edit-description {\n        height: 100px;\n    }\n    .form-row {\n        display: flex;\n        justify-content: center;\n        align-items: center;\n        gap: 20px;\n        height: 40px;\n        width: 400px;\n    }\n    .title,\n    #edit-title {\n        font-size: 25px;\n        font-weight: bold;\n    }\n    >button {\n        border: none;\n        background-color: var(--content-bg-color);\n        border-radius: 8px;\n        font-weight: bold;\n        font-size: 20px;\n    }\n    .button-holder {\n        display: flex;\n        justify-content: space-evenly;\n        #delete{\n            background-color: rgb(255, 156, 156);\n        }\n        #delete:hover{\n            background-color: rgb(255, 57, 57);\n        }\n        >button {\n            border: none;\n            background-color: var(--grey);\n            padding: 10px;\n            border-radius: 8px;\n            font-weight: bold;\n            font-size: 20px;\n            width: 190px;\n        }\n    }\n    #submit {\n        background-color: white;\n    }\n    #submit:active {\n        background-color: rgb(212, 204, 190);\n    }\n}\n\n/* Checkbox stylizing */\n.check {\n    position: relative;\n    appearance: none;\n    background-color: var(--secondary-bg-color);\n    font: inherit;\n    color: currentColor;\n    width: 25px;\n    height: 25px;\n    border: 0.15em solid currentColor;\n    border-radius: 0.15em;\n    margin: auto;\n}\n.check::before {\n    content: \"\";\n    position: absolute;\n    top: 50%;\n    left: 50%;\n    transform: translate(-50%, -50%) scale(0);\n    background-color: black;\n    width: 15px;\n    height: 15px;\n    clip-path: polygon(14% 44%, 0 65%, 50% 100%, 100% 16%, 80% 0%, 43% 62%);\n    transition: 120ms transform ease-in-out;\n}\n.check:checked::before {\n    transform: translate(-50%, -50%) scale(1);\n}\n\n.star {\n    position: relative;\n    appearance: none;\n    background: no-repeat url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ");\n    background-size: 35px 35px;\n    width: 35px;\n    height: 35px;\n    margin: auto;\n}\n.star::before {\n    content: \"\";\n    position: absolute;\n    top: calc(50% + 7px);\n    left: calc(50% + 6px);\n    transform: translate(-60%, -60%) scale(0);\n    background-color: black;\n    width: 35px;\n    height: 35px;\n    background: no-repeat url(" + ___CSS_LOADER_URL_REPLACEMENT_2___ + ");\n    background-size: 24px 24px;\n    transition: 120ms transform ease-in-out;\n}\n.star:checked::before {\n    transform: translate(-50%, -50%) scale(1);\n}", "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;;;CAGC;AACD;;;;;;;;;;;;;CAaC,SAAS;CACT,UAAU;CACV,SAAS;CACT,eAAe;CACf,aAAa;CACb,wBAAwB;AACzB;AACA,gDAAgD;AAChD;;CAEC,cAAc;AACf;AACA;CACC,cAAc;AACf;AACA;CACC,gBAAgB;AACjB;AACA;CACC,YAAY;AACb;AACA;;CAEC,WAAW;CACX,aAAa;AACd;AACA;CACC,yBAAyB;CACzB,iBAAiB;AAClB;;AAEA;IACI,sBAAsB;IACtB,2BAA2B;IAC3B,kCAAkC;IAClC,mCAAmC;IACnC,sCAAsC;IACtC,wCAAwC;IACxC,sCAAsC;IACtC,uCAAuC;IACvC,oCAAoC;AACxC;AACA;IACI,aAAa;IACb,sBAAsB;;IAEtB,aAAa;AACjB;AACA;IACI,aAAa;IACb,mBAAmB;;IAEnB,aAAa;IACb,sCAAsC;IACtC,gCAAgC;IAChC,eAAe;;IAEf;QACI,YAAY;IAChB;AACJ;;AAEA;IACI,OAAO;IACP,aAAa;IACb,8BAA8B;IAC9B;QACI,aAAa;QACb,sBAAsB;QACtB,sCAAsC;QACtC;YACI,gBAAgB;YAChB,yCAAyC;YACzC,eAAe;YACf,sBAAsB;YACtB,YAAY;YACZ,eAAe;YACf,qBAAqB;YACrB,0CAA0C;YAC1C,eAAe;YACf,gBAAgB;YAChB,iBAAiB;YACjB,gBAAgB;YAChB,SAAS;YACT,UAAU;YACV,UAAU;YACV,oBAAoB;YACpB,kBAAkB;YAClB,kBAAkB;YAClB,qBAAqB;YACrB,kCAAkC;YAClC,yBAAyB;YACzB,4JAA4J;YAC5J,iBAAiB;YACjB,yBAAyB;YACzB,0BAA0B;YAC1B,wBAAwB;YACxB,mBAAmB;QACvB;QACA;YACI,mDAAmD;YACnD,2BAA2B;YAC3B,0CAA0C;YAC1C,mDAAmD;YACnD,WAAW;YACX,YAAY;YACZ,OAAO;YACP,kBAAkB;YAClB,MAAM;YACN,wBAAwB;YACxB,oHAAoH;YACpH,WAAW;QACf;;QAEA;YACI,mDAAmD;YACnD,kDAAkD;QACtD;;QAEA;YACI,0CAA0C;QAC9C;;QAEA;YACI,UAAU;YACV,kBAAkB;QACtB;QACA;YACI,eAAe;YACf,aAAa;YACb,gCAAgC;QACpC;QACA;YACI,aAAa;YACb,sBAAsB;QAC1B;QACA;YACI,SAAS;YACT,aAAa;YACb,iBAAiB;YACjB,gBAAgB;YAChB,yCAAyC;QAC7C;QACA;YACI,0CAA0C;QAC9C;IACJ;IACA;QACI,yCAAyC;QACzC,YAAY;QACZ;YACI,eAAe;YACf,aAAa;YACb,gBAAgB;YAChB,YAAY;YACZ,SAAS;;YAET;gBACI,eAAe;YACnB;QACJ;QACA;;YAEI,aAAa;YACb,sBAAsB;YACtB;gBACI,yBAAyB;YAC7B;YACA;;gBAEI;oBACI,uCAAuC;gBAC3C;gBACA;oBACI,aAAa;oBACb,aAAa;oBACb,sCAAsC;oBACtC,2CAA2C;;oBAE3C;wBACI,oBAAoB;wBACpB,cAAc;oBAClB;oBACA;wBACI,WAAW;wBACX,kBAAkB;wBAClB,eAAe;oBACnB;oBACA;wBACI,eAAe;wBACf,kBAAkB;wBAClB,aAAa;wBACb,SAAS;wBACT;4BACI,OAAO;wBACX;oBACJ;oBACA;wBACI,oBAAoB;wBACpB,cAAc;oBAClB;oBACA;wBACI,oBAAoB;wBACpB,cAAc;wBACd,oEAAkD;wBAClD,qBAAqB;oBACzB;gBACJ;YACJ;YACA;gBACI,SAAS;gBACT,YAAY;gBACZ,gBAAgB;gBAChB,gBAAgB;gBAChB,2CAA2C;YAC/C;YACA;gBACI,uCAAuC;YAC3C;QACJ;IACJ;AACJ;AACA;IACI,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,SAAS;;IAET,YAAY;IACZ,eAAe;IACf,sCAAsC;IACtC,gCAAgC;AACpC;;AAEA;IACI,aAAa;AACjB;AACA;IACI,aAAa;AACjB;AACA;IACI,eAAe;IACf,MAAM;IACN,OAAO;IACP,WAAW;IACX,YAAY;IACZ,oCAAoC;IACpC,UAAU;AACd;AACA;IACI,aAAa;IACb,YAAY;IACZ,kBAAkB;IAClB,QAAQ;IACR,SAAS;IACT,gCAAgC;IAChC,aAAa;IACb,sBAAsB;IACtB,uCAAuC;IACvC,UAAU;IACV,yCAAyC;;IAEzC,aAAa;IACb,sBAAsB;IACtB,mBAAmB;IACnB,6BAA6B;;IAE7B;;QAEI,aAAa;IACjB;IACA;QACI,aAAa;QACb,uBAAuB;QACvB,mBAAmB;QACnB,SAAS;QACT,YAAY;QACZ,YAAY;IAChB;IACA;;QAEI,eAAe;QACf,iBAAiB;IACrB;IACA;QACI,YAAY;QACZ,yCAAyC;QACzC,kBAAkB;QAClB,iBAAiB;QACjB,eAAe;IACnB;IACA;QACI,aAAa;QACb,6BAA6B;QAC7B;YACI,oCAAoC;QACxC;QACA;YACI,kCAAkC;QACtC;QACA;YACI,YAAY;YACZ,6BAA6B;YAC7B,aAAa;YACb,kBAAkB;YAClB,iBAAiB;YACjB,eAAe;YACf,YAAY;QAChB;IACJ;IACA;QACI,uBAAuB;IAC3B;IACA;QACI,oCAAoC;IACxC;AACJ;;AAEA,uBAAuB;AACvB;IACI,kBAAkB;IAClB,gBAAgB;IAChB,2CAA2C;IAC3C,aAAa;IACb,mBAAmB;IACnB,WAAW;IACX,YAAY;IACZ,iCAAiC;IACjC,qBAAqB;IACrB,YAAY;AAChB;AACA;IACI,WAAW;IACX,kBAAkB;IAClB,QAAQ;IACR,SAAS;IACT,yCAAyC;IACzC,uBAAuB;IACvB,WAAW;IACX,YAAY;IACZ,uEAAuE;IACvE,uCAAuC;AAC3C;AACA;IACI,yCAAyC;AAC7C;;AAEA;IACI,kBAAkB;IAClB,gBAAgB;IAChB,6DAA4C;IAC5C,0BAA0B;IAC1B,WAAW;IACX,YAAY;IACZ,YAAY;AAChB;AACA;IACI,WAAW;IACX,kBAAkB;IAClB,oBAAoB;IACpB,qBAAqB;IACrB,yCAAyC;IACzC,uBAAuB;IACvB,WAAW;IACX,YAAY;IACZ,6DAAiD;IACjD,0BAA0B;IAC1B,uCAAuC;AAC3C;AACA;IACI,yCAAyC;AAC7C","sourcesContent":["/* http://meyerweb.com/eric/tools/css/reset/ \n   v2.0 | 20110126\n   License: none (public domain)\n*/\nhtml, body, div, span, applet, object, iframe,\nh1, h2, h3, h4, h5, h6, p, blockquote, pre,\na, abbr, acronym, address, big, cite, code,\ndel, dfn, em, img, ins, kbd, q, s, samp,\nsmall, strike, strong, sub, sup, tt, var,\nb, u, i, center,\ndl, dt, dd, ol, ul, li,\nfieldset, form, label, legend,\ntable, caption, tbody, tfoot, thead, tr, th, td,\narticle, aside, canvas, details, embed, \nfigure, figcaption, footer, header, hgroup, \nmenu, nav, output, ruby, section, summary,\ntime, mark, audio, video {\n\tmargin: 0;\n\tpadding: 0;\n\tborder: 0;\n\tfont-size: 100%;\n\tfont: inherit;\n\tvertical-align: baseline;\n}\n/* HTML5 display-role reset for older browsers */\narticle, aside, details, figcaption, figure, \nfooter, header, hgroup, menu, nav, section {\n\tdisplay: block;\n}\nbody {\n\tline-height: 1;\n}\nol, ul {\n\tlist-style: none;\n}\nblockquote, q {\n\tquotes: none;\n}\nblockquote:before, blockquote:after,\nq:before, q:after {\n\tcontent: '';\n\tcontent: none;\n}\ntable {\n\tborder-collapse: collapse;\n\tborder-spacing: 0;\n}\n\n* {\n    box-sizing: border-box;\n    /*outline: 1px red dashed;*/\n    --main-bg-color: rgb(87, 111, 114);\n    --side-bg-color: rgb(125, 157, 156);\n    --content-bg-color: rgb(237, 231, 221);\n    --secondary-bg-color: rgb(247, 244, 239);\n    --project-bg-color: rgb(169, 200, 199);\n    --selected-bg-color: rgb(200, 239, 238);\n    --hover-bg-color: rgb(255, 253, 249);\n}\nbody {\n    display: flex;\n    flex-direction: column;\n\n    height: 100vh;\n}\nheader {\n    display: flex;\n    align-items: center;\n\n    height: 105px;\n    background-color: var(--main-bg-color);\n    color: var(--secondary-bg-color);\n    font-size: 55px;\n\n    #logo {\n        height: 88px;\n    }\n}\n\nmain {\n    flex: 1;\n    display: grid;\n    grid-template: 1fr / 250px 1fr;\n    .side-bar {\n        display: flex;\n        flex-direction: column;\n        background-color: var(--side-bg-color);\n        #nav-button {\n            appearance: none;\n            background-color: var(--project-bg-color);\n            border-width: 0;\n            box-sizing: border-box;\n            color: black;\n            cursor: pointer;\n            display: inline-block;\n            font-family: Clarkson,Helvetica,sans-serif;\n            font-size: 14px;\n            font-weight: 700;\n            letter-spacing: 0;\n            line-height: 1em;\n            margin: 0;\n            opacity: 1;\n            outline: 0;\n            padding: 1.5em 2.2em;\n            position: relative;\n            text-align: center;\n            text-decoration: none;\n            text-rendering: geometricprecision;\n            text-transform: uppercase;\n            transition: opacity 300ms cubic-bezier(.694, 0, 0.335, 1),background-color 100ms cubic-bezier(.694, 0, 0.335, 1),color 100ms cubic-bezier(.694, 0, 0.335, 1);\n            user-select: none;\n            -webkit-user-select: none;\n            touch-action: manipulation;\n            vertical-align: baseline;\n            white-space: nowrap;\n        }\n        #nav-button:before {\n            animation: opacityFallbackOut .5s step-end forwards;\n            backface-visibility: hidden;\n            background-color: var(--selected-bg-color);\n            clip-path: polygon(-1% 0, 0 0, -25% 100%, -1% 100%);\n            content: \"\";\n            height: 100%;\n            left: 0;\n            position: absolute;\n            top: 0;\n            transform: translateZ(0);\n            transition: clip-path .5s cubic-bezier(.165, 0.84, 0.44, 1), -webkit-clip-path .5s cubic-bezier(.165, 0.84, 0.44, 1);\n            width: 100%;\n        }\n\n        #nav-button:hover:before {\n            animation: opacityFallbackIn 0s step-start forwards;\n            clip-path: polygon(0 0, 101% 0, 101% 101%, 0 101%);\n        }\n\n        #nav-button.selected {\n            background-color: var(--selected-bg-color);\n        }\n\n        #nav-button span {\n            z-index: 1;\n            position: relative;\n        }\n        #project-title {\n            font-size: 35px;\n            padding: 10px;\n            color: var(--secondary-bg-color);\n        }\n        #projects {\n            display: flex;\n            flex-direction: column;\n        }\n        #add-project {\n            border: 0;\n            padding: 10px;\n            font-size: larger;\n            font-weight: 900;\n            background-color: var(--project-bg-color);\n        }\n        #add-project:hover {\n            background-color: var(--selected-bg-color);\n        }\n    }\n    .content {\n        background-color: var(--content-bg-color);\n        color: black;\n        #content-header {\n            font-size: 35px;\n            display: flex;\n            align-items: end;\n            padding: 5px;\n            gap: 15px;\n\n            #date-string {\n                font-size: 18px;\n            }\n        }\n        #task-container,\n        #inbox-container {\n            display: flex;\n            flex-direction: column;\n            .late {\n                color: rgb(255, 113, 113);\n            }\n            #tasks,\n            #inboxs {\n                .card:hover {\n                    background-color: var(--hover-bg-color);\n                }\n                .card {\n                    padding: 10px;\n                    display: grid;\n                    grid-template: 3fr 2fr / 50px 8fr 50px;\n                    background-color: var(--secondary-bg-color);\n                    \n                    .check{\n                        grid-row: 1 / span 2;\n                        grid-column: 1;\n                    }\n                    .title{\n                        grid-row: 1;\n                        grid-column: 2 / 3;\n                        font-size: 20px;\n                    }\n                    .info{\n                        grid-row: 2 / 3;\n                        grid-column: 2 / 3;\n                        display: flex;\n                        gap: 10px;\n                        .date {\n                            flex: 1;\n                        }\n                    }\n                    .star{\n                        grid-row: 1 / span 2;\n                        grid-column: 3;\n                    }\n                    .trash {\n                        grid-row: 1 / span 2;\n                        grid-column: 3;\n                        background: no-repeat center url(./pics/trash.svg);\n                        background-size: 30px;\n                    }\n                }\n            }\n            #add-task {\n                border: 0;\n                padding: 5px;\n                font-size: large;\n                font-weight: 900;\n                background-color: var(--secondary-bg-color);\n            }\n            #add-task:hover {\n                background-color: var(--hover-bg-color);\n            }\n        }\n    }\n}\nfooter {\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    gap: 15px;\n\n    height: 50px;\n    font-size: 18px;\n    background-color: var(--main-bg-color);\n    color: var(--secondary-bg-color);\n}\n\n.hidden {\n    display: none;\n}\n#project-form {\n    height: 230px;\n}\n#overlay {\n    position: fixed;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n    background-color: rgba(0, 0, 0, 0.5);\n    z-index: 1;\n}\nform {\n    height: 400px;\n    width: 500px;\n    position: absolute;\n    top: 50%;\n    left: 50%;\n    transform: translate(-50%, -50%);\n    padding: 20px;\n    background-color: #fff;\n    box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);\n    z-index: 2;\n    background-color: var(--content-bg-color);\n\n    display: flex;\n    flex-direction: column;\n    align-items: center;\n    justify-content: space-evenly;\n\n    #description,\n    #edit-description {\n        height: 100px;\n    }\n    .form-row {\n        display: flex;\n        justify-content: center;\n        align-items: center;\n        gap: 20px;\n        height: 40px;\n        width: 400px;\n    }\n    .title,\n    #edit-title {\n        font-size: 25px;\n        font-weight: bold;\n    }\n    >button {\n        border: none;\n        background-color: var(--content-bg-color);\n        border-radius: 8px;\n        font-weight: bold;\n        font-size: 20px;\n    }\n    .button-holder {\n        display: flex;\n        justify-content: space-evenly;\n        #delete{\n            background-color: rgb(255, 156, 156);\n        }\n        #delete:hover{\n            background-color: rgb(255, 57, 57);\n        }\n        >button {\n            border: none;\n            background-color: var(--grey);\n            padding: 10px;\n            border-radius: 8px;\n            font-weight: bold;\n            font-size: 20px;\n            width: 190px;\n        }\n    }\n    #submit {\n        background-color: white;\n    }\n    #submit:active {\n        background-color: rgb(212, 204, 190);\n    }\n}\n\n/* Checkbox stylizing */\n.check {\n    position: relative;\n    appearance: none;\n    background-color: var(--secondary-bg-color);\n    font: inherit;\n    color: currentColor;\n    width: 25px;\n    height: 25px;\n    border: 0.15em solid currentColor;\n    border-radius: 0.15em;\n    margin: auto;\n}\n.check::before {\n    content: \"\";\n    position: absolute;\n    top: 50%;\n    left: 50%;\n    transform: translate(-50%, -50%) scale(0);\n    background-color: black;\n    width: 15px;\n    height: 15px;\n    clip-path: polygon(14% 44%, 0 65%, 50% 100%, 100% 16%, 80% 0%, 43% 62%);\n    transition: 120ms transform ease-in-out;\n}\n.check:checked::before {\n    transform: translate(-50%, -50%) scale(1);\n}\n\n.star {\n    position: relative;\n    appearance: none;\n    background: no-repeat url('./pics/star.svg');\n    background-size: 35px 35px;\n    width: 35px;\n    height: 35px;\n    margin: auto;\n}\n.star::before {\n    content: \"\";\n    position: absolute;\n    top: calc(50% + 7px);\n    left: calc(50% + 6px);\n    transform: translate(-60%, -60%) scale(0);\n    background-color: black;\n    width: 35px;\n    height: 35px;\n    background: no-repeat url('./pics/star-fill.svg');\n    background-size: 24px 24px;\n    transition: 120ms transform ease-in-out;\n}\n.star:checked::before {\n    transform: translate(-50%, -50%) scale(1);\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var date_fns_differenceInHours__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! date-fns/differenceInHours */ "./node_modules/date-fns/esm/differenceInHours/index.js");
...
list.addTask('Homework', 'Math HW section 2-4', (0,date_fns_addDays__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), -1), '🏫 School', false);
list.addTask('Science Homework', 'Biology HW posted on canvas', new Date(), '🏫 School', true);
list.addTask('Email Jenny', 'Ask about reports', (0,date_fns_addDays__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), 1), '💼 Work', false);
list.addTask('Excel report', 'Add up expenses', (0,date_fns_addDays__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), 4), '💼 Work', false);
list.addTask('Senior Design Project', 'Design freeze report', new Date(), '🏫 School', true);
list.addTask('Lab Report', 'Heat transfer lab 4', (0,date_fns_addDays__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(), 30), '🏫 School', true);
...
const taskUI = {
    ...
    displayDate: function() {
        this.dateDisplay.textContent = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])((new Date()), 'iiii MMMM d, y');
    },
    ...
    displayTasks: function(page) {
        ...
        // Sort tasks by date
        this.alltasks.sort((a, b) => (0,date_fns_compareAsc__WEBPACK_IMPORTED_MODULE_3__["default"])(a.date, b.date));
        this.inbox.sort((a, b) => (0,date_fns_compareAsc__WEBPACK_IMPORTED_MODULE_3__["default"])(a.date, b.date));
    ...
    createCard: function(object, parent) {
        ...
        if (object['date']) {
            ...
            const difference = Math.floor((0,date_fns_differenceInHours__WEBPACK_IMPORTED_MODULE_4__["default"])(today, object['date'])/24)|0;
            if (difference === 0) {
                date.textContent = '📅 Due Today';
                object.todo = true;
            } else if (difference > 0) {
                date.textContent = '📅' + (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(object['date'], ' MMM d y');
...
const formUI = {
    ...
    presetVal: function(object) {
        ...
        this.editTaskDate.value = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(object.date, 'yyyy-MM-dd');
    },
    cardButton: function(object) {
        this.editForm.addEventListener('submit', function(event) {
            ...
            object.date = (0,date_fns_addDays__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(formUI.editTaskDate.value), 1);
    ...
    formButton: function() {
        ...
        this.taskForm.addEventListener('submit', function(event) {
            ...
            if (formUI.taskDescription.value) {
                let taskDate = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(formUI.taskDate.value.split('-')), 'MMM d y');
                let todayDate = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_2__["default"])(today, 'MMM d y');
